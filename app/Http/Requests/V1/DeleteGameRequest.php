 ...
 *
 * Petición para eliminar los datos de un juego: Permite validar los datos enviados antes de pasarlos al controlador
...
class DeleteGameRequest extends FormRequest
{
    ...
    {
        return [
            'id.integer' => 'El identificador del juego debe ser un número entero',
            'id.required' => 'El identificador del juego es obligatorio',
        ];
    }
}
